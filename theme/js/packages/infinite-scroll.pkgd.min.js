  ...
  (function (t, e) {
    ...
    ((r.log = function (t, e) {
      ...
      (r.updateScroller = function () {
        ...
        if (e) {
          if (((this.scroller = !0 === e ? this.element : i.getQueryElement(e)), !this.scroller))
  ...
  (function (t, e) {
    ...
    return (
      (i.loadNextPage = function () {
        ...
        let { responseBody: t, domParseResponse: e, fetchOptions: i } = this.options,
      ...
      (n.getBottomDistance = function () {
        ...
        return (
          this.options.elementScroll
            ...
            : ((e = this.top + this.element.clientHeight), (i = t.scrollY + this.windowHeight)),
          e - i
        );
      }),
      (n.onResize = function () {
