            ...
            o.specified &&
              ((s =
                'href' === (n = o.name)
                  ? 'src'
                  : (n = (n =
                      (n = n.replace('data-', '')).charAt(0).toLowerCase() +
                      n.slice(1)).replace(/-([a-z])/g, function (t) {
            ...
            : o
              ...
              : f
                ...
                : (this.setImgMarkup(g, n, e),
                  (r || a) &&
                    ((p = n.find('.lg-object')), this.initPictureFill(p))),
            ...
            n.hasClass('lg-loaded') ||
              setTimeout(function () {
                ;(n.find('.lg-img-wrap').append(w(e, g, '', r, l, s.sources)),
                  (r || a) &&
                    ((t = n.find('.lg-object')), i.initPictureFill(t)),
              ...
              setTimeout(
                function () {
                  ;(h.lGalleryOn && h.loadContent(t, !0),
                    '.lg-sub-html' === h.settings.appendSubHtmlTo &&
                      h.addHtml(t))
                },
