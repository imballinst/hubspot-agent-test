...
!(function (t, e) {
  ...
  var r =
    ...
    (s.prototype.toggleClass = function (t) {
      return (
        this.firstElement && (this.hasClass(t) ? this.removeClass(t) : this.addClass(t)), this
      );
    }),
    ...
    (s.prototype.scrollTop = function (t) {
      return void 0 !== t
        ? ((document.body.scrollTop = t), (document.documentElement.scrollTop = t), this)
        : window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
    }),
    (s.prototype.scrollLeft = function (t) {
      return void 0 !== t
        ? ((document.body.scrollLeft = t), (document.documentElement.scrollLeft = t), this)
        : window.pageXOffset ||
    ...
    (s.prototype.height = function () {
      var t = this.style();
      return (
        this.firstElement.clientHeight - parseFloat(t.paddingTop) - parseFloat(t.paddingBottom)
      );
    }),
    (s.eventListeners = {}),
    s);
  ...
  var I = function (t, e, i, s) {
    ...
    E = function (t, e, i, s) {
      return (
        ...
        (s && s.youtube ? "lg-has-youtube" : s && s.vimeo ? "lg-has-vimeo" : "lg-has-html5") +
        '" style="' +
        i +
            ...
            o.specified &&
              ((s =
                "href" === (n = o.name)
                  ? "src"
                  : (n = (n =
                      (n = n.replace("data-", "")).charAt(0).toLowerCase() + n.slice(1)).replace(
                      /-([a-z])/g,
                      function (t) {
    ...
    P =
      ((t.prototype.generateSettings = function (t) {
        ((this.settings = e(e({}, a), t)),
          (this.settings.isMobile && "function" == typeof this.settings.isMobile
            ? this.settings.isMobile()
            : o()) &&
            ((t = e(e({}, this.settings.mobileSettings), this.settings.mobileSettings)),
      ...
      (t.prototype.buildStructure = function () {
        ...
        (this.$container && this.$container.get()) ||
          ...
          ".lg-sub-html" === this.settings.appendSubHtmlTo &&
            (l = '<div class="lg-sub-html" role="status" aria-live="polite"></div>'),
          (e = ""),
                ...
                : this.settings.selector
                  ? "string" == typeof this.settings.selector
                    ? this.settings.selectWithin
                      ? ((t = C(this.settings.selectWithin)),
        ...
        (void 0 === e && (e = this.settings.index),
          this.lgOpened ||
            ...
            this.zoomFromOrigin &&
              ...
              (s = l(t, this.$lgContent, n, o, this.currentImageSize))),
              ...
              (r.zoomFromOrigin &&
                ...
                setTimeout(function () {
                  (t
                    ...
                    .css("transition-duration", r.settings.startAnimationDuration + "ms"),
      ...
      (t.prototype.addHtml = function (t) {
        ...
        (this.galleryItems[t].subHtmlUrl
          ...
          ".lg-sub-html" === this.settings.appendSubHtmlTo
            ...
            : ((s = C(this.getSlideItemId(t))),
              i ? s.load(i) : s.append('<div class="lg-sub-html">' + e + "</div>")),
          null != e &&
            ("" === e
      ...
      (t.prototype.handleLgObjectLoad = function (t, e, i, s, n) {
        ...
        setTimeout(function () {
          (t.addClass("lg-complete lg-complete_"),
            n || o.LGel.trigger(p, { index: e, delay: i || 0 }));
        }, s);
      }),
      ...
      (t.prototype.loadContent = function (e, t) {
        ...
        n.hasClass("lg-loaded") ||
          (f &&
            ((c = (u = this.mediaContainerPosition).top),
            (u = u.bottom),
            (u = I(this.items[e], this.$lgContent, c + u, f && this.settings.videoMaxSize)),
            (y = this.getVideoContStyle(u))),
          h
            ? ((p = x(g, this.settings.iframeWidth, this.settings.iframeHeight, s.iframeTitle)),
              n.prepend(p))
            : o
              ? ((u = ""),
                (m = !this.lGalleryOn),
                (h = !this.lGalleryOn && this.zoomFromOrigin && this.currentImageSize) &&
                  (u = this.getDummyImageContent(n, e, "")),
                (p = E(o, u || "", y, f)),
                n.prepend(p),
                (h =
                  (h ? this.settings.startAnimationDuration : this.settings.backdropDuration) +
                  100),
                setTimeout(function () {
                  i.LGel.trigger(L, {
                    index: e,
              ...
              : f
                ? ((p = '<div class="lg-video-cont " style="' + y + '"></div>'),
                  n.prepend(p),
                  this.LGel.trigger(L, { index: e, src: g, html5Video: d, hasPoster: !1 }))
                : (this.setImgMarkup(g, n, e),
                  (r || a) && ((p = n.find(".lg-object")), this.initPictureFill(p))),
        ...
        (this.lGalleryOn ||
          ...
          !this.lGalleryOn &&
            ...
            n.hasClass("lg-loaded") ||
              setTimeout(function () {
                (n.find(".lg-img-wrap").append(w(e, g, "", r, l, s.sources)),
                  (r || a) && ((t = n.find(".lg-object")), i.initPictureFill(t)),
                  i.onLgObjectLoad(n, e, b, v, !0));
        ...
        return (
          this.settings.loop &&
            (t === this.galleryItems.length - 1
              ...
              : 0 === t && n.push("lg-item-" + this.lgId + "-" + (this.galleryItems.length - 1))),
      ...
      (t.prototype.setDownloadValue = function (t) {
        var e;
        !this.settings.download ||
          ((t = !1 !== (e = this.galleryItems[t]).downloadUrl && (e.downloadUrl || e.src)) &&
            !e.iframe &&
          ...
          (this.lGalleryOn && d === t) ||
            ...
            this.lgBusy ||
              ...
              a &&
                ...
                (g = g.bottom),
                (g = I(this.items[t], this.$lgContent, l + g, a && this.settings.videoMaxSize)),
              ...
              e
                ...
                : this.makeSlideAnimation(s, o, r),
              this.lGalleryOn || this.loadContent(t, !0),
              setTimeout(
                function () {
                  (h.lGalleryOn && h.loadContent(t, !0),
                    ".lg-sub-html" === h.settings.appendSubHtmlTo && h.addHtml(t));
                },
              ...
              setTimeout(
                function () {
                  ((h.lgBusy = !1),
                    ...
                    h.LGel.trigger(y, { prevIndex: d, index: t, fromTouch: e, fromThumb: i }));
                },
      ...
      (t.prototype.touchMove = function (t, e) {
        ...
        (this.swipeDirection
          ...
          : 15 < Math.abs(s)
            ...
            : 15 < Math.abs(n) && ((this.swipeDirection = "vertical"), (e = !0)),
          e &&
            ((t = this.getSlideItem(this.index)),
            "horizontal" === this.swipeDirection
              ? (this.outer.addClass("lg-dragging"),
                this.setTranslate(t, s, 0),
                (i = (15 * (e = t.get().offsetWidth)) / 100 - Math.abs((10 * s) / 100)),
                this.setTranslate(this.outer.find(".lg-prev-slide").first(), s - e - i, 0),
                this.setTranslate(this.outer.find(".lg-next-slide").first(), e + s + i, 0))
              : "vertical" === this.swipeDirection &&
                this.settings.swipeToClose &&
                (this.$container.addClass("lg-dragging-vertical"),
                (i = 1 - Math.abs(n) / window.innerHeight),
                this.$backdrop.css("opacity", i),
                (i = 1 - Math.abs(n) / (2 * window.innerWidth)),
                this.setTranslate(t, 0, n, i, i),
                100 < Math.abs(n) &&
        ...
        ("lg-slide" !== this.settings.mode && this.outer.addClass("lg-slide"),
          setTimeout(function () {
            ...
            if ("horizontal" === r.swipeDirection) {
              ...
              o < 0 && e > r.settings.swipeThreshold
                ? (r.goToNextSlide(!0), (t = !1))
                : 0 < o && e > r.settings.swipeThreshold && (r.goToPrevSlide(!0), (t = !1));
            } else if ("vertical" === r.swipeDirection) {
              if (
                ((o = Math.abs(i.pageY - s.pageY)),
                r.settings.closable && r.settings.swipeToClose && 100 < o)
              )
            ...
            (r.outer.find(".lg-item").removeAttr("style"),
              t &&
                ...
                ((t = C(n.target)), r.isPosterElement(t) && r.LGel.trigger(v)),
      ...
      (t.prototype.enableSwipe = function () {
        ...
        this.settings.enableSwipe &&
          (this.$inner.on("touchstart.lg", function (t) {
            ...
            (!C(t.target).hasClass("lg-item") && !e.get().contains(t.target)) ||
              ...
              (i.touchAction = "swipe"),
              i.manageSwipeClass(),
              (s = { pageX: t.targetTouches[0].pageX, pageY: t.targetTouches[0].pageY }));
          }),
          this.$inner.on("touchmove.lg", function (t) {
            (t.preventDefault(),
              o &&
                "swipe" === i.touchAction &&
                1 === t.targetTouches.length &&
                ((e = { pageX: t.targetTouches[0].pageX, pageY: t.targetTouches[0].pageY }),
                i.touchMove(s, e),
                (n = !0)));
          }),
          this.$inner.on("touchend.lg", function (t) {
            "swipe" === i.touchAction &&
              (n
                ...
                : o && ((t = C(t.target)), i.isPosterElement(t) && i.LGel.trigger(v)),
        ...
        this.settings.enableDrag &&
          ...
          C(window).on("mouseup.lg.global" + this.lgId, function (t) {
            ...
            i.lgOpened &&
              ((e = C(t.target)),
              r
                ? ((r = !1), i.touchEnd(n, s, t), i.LGel.trigger(z))
                : i.isPosterElement(e) && i.LGel.trigger(v),
              o && ((o = !1), i.outer.removeClass("lg-grabbing").addClass("lg-grab")));
          }));
      }),
      ...
      (t.prototype.goToPrevSlide = function (t) {
        ...
        (t && this.galleryItems.length < 3 && (i = !1),
          this.lgBusy ||
            (0 < this.index
              ? (this.index--,
                this.LGel.trigger(M, { index: this.index, fromTouch: t }),
      ...
      (t.prototype.mousewheel = function () {
        ...
        this.outer.on("mousewheel.lg", function (t) {
          !t.deltaY ||
            ...
            (0 < t.deltaY ? e.goToPrevSlide() : e.goToNextSlide(), t.preventDefault());
        });
      }),
      ...
      (t.prototype.closeGallery = function (t) {
        ...
        (this.zoomFromOrigin &&
          n &&
          ((i = (o = this.mediaContainerPosition).top),
          (t = o.bottom),
          (o = I(
            n,
            this.$lgContent,
            i + t,
            this.galleryItems[this.index].__slideVideoInfo && this.settings.videoMaxSize,
          )),
          (s = l(n, this.$lgContent, i, t, o))),
          this.zoomFromOrigin && s
