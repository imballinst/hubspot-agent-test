(function () {
  ...
  var focus_mobile_nav_container = document.querySelector(".focus_mobile_nav_container");
  var navToggle = document.querySelector(".focus_mob_nav_check");

  var focus_window = document.querySelector(".focus_window");
  ...
  var allElementsToClose = document.querySelectorAll(".focus_window, .m_w_languages, .m_w_search");
  ...
  function toggleNav() {
    focus_mobile_nav_container.classList.toggle("open");
  }

  // Function for toggling mobile language selector
  function toggleLang() {
    focus_window.classList.toggle("open");
...
var stickyBar = document.getElementById("focus_sticky_bar");
